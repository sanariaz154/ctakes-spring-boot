...
import org.apache.ctakes.preprocessor.ae.*;
...
final public class MyClinicalPipelineFactory {

   private MyClinicalPipelineFactory() {
   }

   
   
   public static AnalysisEngineDescription getCdaPipeline() throws ResourceInitializationException, MalformedURLException{
...
//	      builder.add(AnalysisEngineFactory.createEngineDescription(ChunkAdjuster.class));
...
//	      builder.add(AnalysisEngineFactory.createEngineDescription(ConstituencyParser.class));
//	      //builder = aggregateBuilder.createAggregate();
//
//	      return builder.createAggregateDescription();
	   }
   ...
   public static AnalysisEngineDescription getDefaultPipeline() throws ResourceInitializationException, IOException, UIMAException{
   ...
   // Sana's commit
   public static AnalysisEngineDescription getNewPipeline() throws ResourceInitializationException, IOException, UIMAException{
	   ...
	   builder.add( SentenceDetector.createAnnotatorDescription() );
	      ...
	      builder.add( GenericCleartkAnalysisEngine.createAnnotatorDescription() );
	      builder.add( SubjectCleartkAnalysisEngine.createAnnotatorDescription() );
	      //builder.add( AnalysisEngineFactory.createEngineDescription( NegationContextAnalyzer.class ) );
	      builder.add( ClearNLPDependencyParserAE.createAnnotatorDescription() );
	      builder.add( AnalysisEngineFactory.createEngineDescription( ConstituencyParser.class ) );
	      builder.add(AnalysisEngineFactory.createEngineDescription(ClearNLPSemanticRoleLabelerAE.class));
	     // builder.add( AnalysisEngineFactory.createEngineDescription( RelationExtractorAnnotator.class ) );
	    //  builder.add( AnalysisEngineFactory.createEngineDescription( EventCoreferenceAnnotator.class ) );
